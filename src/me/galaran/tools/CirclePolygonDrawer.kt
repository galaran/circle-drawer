...
//    private val image = ImageIO.read(javaClass.getResourceAsStream("/cat.png"))
...
//                g2d.drawImage(image.getScaledInstance(image.width * circleRadius / WIN_SIZE,
//                    image.height * circleRadius / WIN_SIZE, Image.SCALE_SMOOTH), 0, 0, null)
            }
